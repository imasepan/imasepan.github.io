...
const createSunlitField = () => {
  ...
  field.innerHTML = `<svg class="sunlit-filter-defs" aria-hidden="true"><defs><filter id="sunlit-leaf-wind" x="-8%" y="-8%" width="116%" height="116%" color-interpolation-filters="sRGB"><feTurbulence type="fractalNoise" baseFrequency=".006 .004" numOctaves="1" seed="7" result="wind-noise"><animate attributeName="baseFrequency" dur="18s" keyTimes="0;0.33;0.66;1" values=".006 .004;.009 .007;.007 .003;.006 .004" repeatCount="indefinite"></animate></feTurbulence><feDisplacementMap in="SourceGraphic" in2="wind-noise" scale="18" xChannelSelector="R" yChannelSelector="G"><animate attributeName="scale" dur="14s" keyTimes="0;0.5;1" values="14;24;14" repeatCount="indefinite"></animate></feDisplacementMap></filter></defs></svg><div class="sunlit-blur"><span></span><span></span><span></span></div><div class="sunlit-glow"></div><div class="sunlit-bounce"></div><div class="sunlit-perspective"><div class="sunlit-leaf-shadow"><span class="sunlit-leaf-layer"></span><span class="sunlit-leaf-layer"></span><span class="sunlit-leaf-layer"></span></div><div class="sunlit-blinds"><div class="sunlit-shutters">${'<span class="sunlit-shutter"></span>'.repeat(18)}</div><div class="sunlit-bars"><span class="sunlit-bar"></span><span class="sunlit-bar"></span></div></div></div>`;
